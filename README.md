...
* Four-digit year, space, short month name, space, two-digit month, space, short weekday name, space, two-digit hour, colon, two-digit minute, colon, two-digit second, space, Z, offset sign, two-digit hour offset, two-digit minute offset, colon, short time zone.
